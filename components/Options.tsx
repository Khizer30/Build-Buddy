    ...
    <>
      <div className=" my-4 grid grid-cols-2 md:grid-cols-4">
        ...
        <div className=" p-4 col-span-1 flex flex-col justify-center items-center">
          ...
          <h6 className=" my-4 md:my-6 font-primary text-center text-sm md:text-base text-white"> Architect </h6>
        </div>
        ...
        <div className=" p-4 col-span-2 order-3 md:order-2 flex flex-col justify-center items-center">
          ...
          <h6 className=" my-4 md:my-6 font-primary text-center text-sm md:text-base text-white"> Information </h6>
        </div>

        <div className=" p-4 col-span-1 order-2 md:order-4 flex flex-col justify-center items-center">
          <Link href="/menu/suppliers">
            <Image
              src={ img2 }
              alt="Suppliers"
              draggable="false"
          ...
          <h6 className=" my-4 md:my-6 font-primary text-center text-sm md:text-base text-white"> Suppliers </h6>
        </div >
